                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                        <ul class="nav navbar-nav menu_nav ml-auto">
                            ...
                            <li class="nav-item"><a class="nav-link" href="BAND.php">BANDSTORES</a></li>                                                  
              ...
              <div class="col-lg-4">
                  <div class="media contact-info">
                    ...
                    <div class="media-body">
                            <div>
                              <p><strong><font color="black">กชสิทธ์ นิลนนท์ ID 1600700056</font></strong>                            </p>
                        </div>
                ...
                <div class="media contact-info">
                        ...
                        <div class="media-body">
                            <h3>นัฐ แซ่ลี้ ID 1600700148                        </h3>
                    </div>
                  </div>
                <div class="media contact-info">
            ...
            <div class="row">
                <div class="col-lg-4  col-md-6 col-sm-6">
                    <div class="single-footer-widget">
                        <h6>About Us</h6>
                        <p>
                            โปรเจคกลุ่ม วิชา SE412 Internet Programming I ปีการศึกษา 2561 ภาคการเรียนที่ 2
                      </p>
